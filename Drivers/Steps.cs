...
namespace tflpro.Drivers
{
    ...
    public abstract class Steps : IContainerDependentObject
    {
        ...
        {
            if (objectContainer != null) throw new SpecFlowException("Container of the steps class has already initialized!");
        ...
        {
            if (objectContainer == null) throw new SpecFlowException("Container of the steps class has not been initialized!");
        }
        #region Given
